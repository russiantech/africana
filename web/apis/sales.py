...
from web.apis.utils import error_response, success_response, generator
...
def delete_sale(sale_id):
    try:
        ...
        sqlalchemy.orm.exc.DetachedInstanceError: Parent instance <Sales at 0x226c46caf30> is not bound to a Session; lazy load operation of attribute 'item' cannot proceed (Background on this error at: https://sqlalche.me/e/20/bhk3)
        """
        # sale = Sales.query.get(sale_id)
